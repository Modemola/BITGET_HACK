...
CLAIMS: list[tuple[str, str, str, str, float]] = [
    ...
    ("docs/FORM_ANSWER.md", r"worst in my sample was ([\d.]+)%",
     "summary.worst_terminal_drift", "pct", 0.01),
    ("docs/FORM_ANSWER.md", r"([\d.]+)% mean absolute",
     "summary.mean_abs_terminal_drift", "pct", 0.01),
    ("docs/FORM_ANSWER.md", r"([\d.]+)% at the 95th percentile",
     "summary.p95_abs_terminal_drift", "pct", 0.01),
    ("docs/FORM_ANSWER.md", r"([\d,]+) hourly bars of NVDAx",
     "coverage.bars", "int_comma", 0),
    ("docs/FORM_ANSWER.md", r"(\d+) weekend blackouts",
     "summary.n_windows", "int", 0),
