...
[![tests](https://img.shields.io/badge/tests-209%20passing-63BE9A)](tests/)
...
build. 209 tests, hermetic — they pass with every socket blocked.
...
tests/            209 tests, including jsdom render and JS/Python parity checks
