...
[![tests](https://img.shields.io/badge/tests-208%20passing-63BE9A)](tests/)
...
build. 208 tests, hermetic — they pass with every socket blocked.
...
tests/            208 tests, including jsdom render and JS/Python parity checks
